...
import styles from './genre_page_style'
import TruncateText from '../truncatext/truncatext'
...
const Screen = ({navigation})=>{   
    ...
    return (   
                <Stack.Navigator >
                    <Stack.Screen  name='Recomandation' component={Screen} options={{headerShown:false  }} />
